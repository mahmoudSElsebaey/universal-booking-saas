...
export default function BookingPage() {
  ...
  useEffect(() => {
    ...
    const catalogStaff = (window as any).__catalogStaff as
      | StaffMember[]
      | undefined;
    ...
    return (
      <div className="container-app py-16 max-w-lg mx-auto text-center">
        ...
        <p className="text-text-secondary mb-2">
          {service && (isAr ? service.nameAr || service.name : service.name)} ·{" "}
          {date} · {time}
        </p>
        <p className="text-caption text-success mb-6">
  ...
  return (
    <div
      className="container-app mx-auto w-full py-8 md:py-12"
          ...
          {step === "review" && service && (
            <div className="space-y-4">
              ...
              <div className="rounded-md bg-surface-muted p-4 space-y-2 text-sm">
                <Row
                  label={t("booking:chooseService")}
                  value={isAr ? service.nameAr || service.name : service.name}
                />
                <Row
