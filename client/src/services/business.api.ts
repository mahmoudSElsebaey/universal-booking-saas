...
export const businessApi = {
  create: (data: Partial<Business>) =>
    api
      .post<{ success: boolean; data: Business }>("/businesses", data)
      .then((r) => r.data.data),

  getMine: () =>
    api
      .get<{ success: boolean; data: Business[] }>("/businesses/mine")
      .then((r) => r.data.data),

  getById: (id: string) =>
    api
      .get<{ success: boolean; data: Business }>(`/businesses/${id}`)
      .then((r) => r.data.data),
  ...
  createCategory: (businessId: string, data: Partial<Category>) =>
    api
      .post<{
        success: boolean;
        data: Category;
      }>(`/businesses/${businessId}/categories`, data)
      .then((r) => r.data.data),
  ...
  createService: (businessId: string, data: Partial<Service>) =>
    api
      .post<{
        success: boolean;
        data: Service;
      }>(`/businesses/${businessId}/services`, data)
      .then((r) => r.data.data),
  ...
  updateService: (businessId: string, id: string, data: Partial<Service>) =>
    api
      .patch<{
        success: boolean;
        data: Service;
      }>(`/businesses/${businessId}/services/${id}`, data)
      .then((r) => r.data.data),
  ...
  updateStaff: (businessId: string, id: string, data: Partial<StaffMember>) =>
    api
      .patch<{
        success: boolean;
        data: StaffMember;
      }>(`/businesses/${businessId}/staff/${id}`, data)
      .then((r) => r.data.data),
